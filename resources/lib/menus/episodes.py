...
##------------------
                ...
                rating = rating.encode('utf-8')
                # xbmc.log('line 869 from episodes.py rating = %s' % rating, 2)
                try:
...
####-Context Menu and Counters-####
                ...
                try:
                    ...
                    if unwatchedEnabled:
                        ...
                        if count:
                            # xbmc.log('line 1739 of episodes count for tvshow title %s = %s' % (str(systvshowtitle), str(count)), 2)
